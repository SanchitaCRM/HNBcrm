...
//    //After create record in subpanel for increasing supbapnel count by Roshan Sarode dt. 3-10-18 start
//    var module = lf;
//    var subpan_rec = $("#" + sp + "_CELL").attr('data-record');
//    var minus_one = parseInt(subpan_rec) - 1;
//    if (minus_one != 1 && parseInt(subpan_rec)>0) {
//     
//        $("#" + sp + "_CELL").attr('data-record', minus_one);
//        $("#" + sp + "_CELL").html("(" + minus_one + ")");
//    }
//    //After create record in subpanel for increasing supbapnel count by Roshan Sarode dt. 3-10-18 end
...
{
    if (typeof (window.document.forms['DetailView'].elements['layout_def_key']) == 'undefined')
        return '';
...
//                    //After create record in subpanel for increasing supbapnel count by Roshan Sarode dt. 3-10-18 start
//                    var get_subpanel = savedModule.split('_').pop().toLowerCase();
//                    var subpan_rec = $("#" + get_subpanel + "_CELL").attr('data-record');
//                    var plus_one = parseInt(subpan_rec) + 1;
//                    $("#" + get_subpanel + "_CELL").attr('data-record', plus_one);
//                    $("#" + get_subpanel + "_CELL").html("(" + plus_one + ")");
//                    //After create record in subpanel for increasing supbapnel count by Roshan Sarode dt. 3-10-18 end
