	...
	<table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view'>
				...
				<table border='0' cellpadding='0' cellspacing='0' width='100%' height='60px'>
					<tr>
						...
						<td  align='right' nowrap='nowrap'>
							...
							<!--Smith-->
							 &nbsp;&nbsp;
								<button  id='popupViewPrevButton' class="btn pagination-icon-bottom btn-outline-primary btnbackcolor" title='{$navStrings.previous}' {if $prerow}onclick='return sListView.save_checks({$pageData.offsets.prev}, "{$moduleString}")' {else} onClick='location.href="{$pageData.urls.prevPage}"'{/if}>
							...
							<!--smith-->
							&nbsp;&nbsp;
								<button id="popupViewPrevButton" class="btn pagination-icon-bottom-disabled btn-outline-primary btnbackcolor" title='{$navStrings.previous}' disabled='disabled' style="color:#6d6d6d">
							...
							<!--Smith-->
							&nbsp;&nbsp;
								<button id="popupViewNextButton" class="btn pagination-icon-bottom btn-outline-primary btnbackcolor" {if $prerow}onclick='return sListView.save_checks({$pageData.offsets.next}, "{$moduleString}")' {else} onClick='location.href="{$pageData.urls.nextPage}"'{/if}>
							...
							<!--smith-->
							&nbsp;&nbsp;
								<button id="popupViewNextButton" class="btn pagination-icon-bottom-disabled btn-outline-primary btnbackcolor" title='{$navStrings.next}' disabled='disabled' style="color:#6d6d6d">
		...
		<tr height='20'>
			...
			{foreach from=$displayColumns key=colHeader item=params}
				{if $colCounter == '0'}<th scope='col' width='{$params.width}%' valign="top" data-toggle="true">
				{else}<th scope='col' width='{$params.width}%' valign="top" data-hide="phone,tablet">{/if}
					<div style='white-space: normal;font-weight: bold;'width='100%' align='{$params.align|default:'left'}' class="text-uppercase">
