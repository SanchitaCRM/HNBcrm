...
/* ------------ Subpanel activities and history module start-------Roshan Sarode-------*/
						...
						{
							 //For adding onclick event to open detailview of History and Activities module detailview by Roshan Sarode 21-03-18 start
           $small_dev_widget_contents="<span class='small_device_his_act_link'>".$widget_contents."</span>";      
                            $widget_contents= "<a href='javascript:void(0)' class='his_act_link' data-stuff='module:".$list_field['module'].",record:".$list_field['fields']['ID']."' onclick='GetDetailViewDeta($(this));'>".$list_field['fields']['NAME']."</a>";
                   
                       //For adding onclick event to open detailview of History and Activities module detailview by Roshan Sarode 21-03-18 end
                    
						$this->xTemplate->assign('CELL', "<strong style='font-size:14px;'>".$widget_contents.$small_dev_widget_contents."</strong>");
...
//                $start_link = "<a name='listViewStartButton' title='{$this->local_app_strings['LNK_LIST_START']}'  disabled style='color:#6d6d6d'><i class='fa fa-angle-double-left fa-lg ' aria-hidden='true'></i></a>";
                ...
                $previous_link = "<button name='listViewPrevButton' title='{$this->local_app_strings['LNK_LIST_PREVIOUS']}' class='btn pagination-icon-bottom-disabled btn-outline-primary btnbackcolor' disabled style='color:#6d6d6d'><i class='fa fa-caret-left fa-lg ' aria-hidden='true'></i></button>";
            } else {
...
//                         $start_link = "<a type='button' name='listViewStartButton' title='{$this->local_app_strings['LNK_LIST_START']}' onClick='javascript:save_checks(0, \"{$moduleString}\");'><i class='fa fa-angle-double-left fa-lg ' aria-hidden='true'></i></a>";
                    ...
                    $previous_link = "<button name='listViewPrevButton' title='{$this->local_app_strings['LNK_LIST_PREVIOUS']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick='javascript:save_checks($previous_offset, \"{$moduleString}\");'><i class='fa fa-caret-left fa-lg ' aria-hidden='true'></i></button>";
...
//                    $start_link = "<a type='button' name='listViewStartButton' title='{$this->local_app_strings['LNK_LIST_START']}' onClick='location.href=\"$start_URL\"; sListView.save_checks(0, \"{$moduleString}\");'><i class='fa fa-angle-double-left fa-lg ' aria-hidden='true'></i><a>";
					...
					$previous_link = "<button name='listViewPrevButton' title='{$this->local_app_strings['LNK_LIST_PREVIOUS']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick='location.href=\"$previous_URL\"; sListView.save_checks($previous_offset, \"{$moduleString}\");'><i class='fa fa-caret-left fa-lg ' aria-hidden='true'></i></button>";
                } else {
                    $onClick = '';
...
//					$start_link = "<a type='button' name='listViewStartButton' title='{$this->local_app_strings['LNK_LIST_START']}' onClick=".$onClick."><i class='fa fa-angle-double-left fa-lg ' aria-hidden='true'></i></a>";
                    ...
                    $previous_link = "<button name='listViewPrevButton' title='{$this->local_app_strings['LNK_LIST_PREVIOUS']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick=".$onClick."><i class='fa fa-caret-left fa-lg ' aria-hidden='true'></i></button>";
...
//				$end_link = "<a type='button' name='listViewEndButton' title='{$this->local_app_strings['LNK_LIST_END']}' disabled style='color:#6d6d6d'><i class='fa fa-angle-double-right fa-lg ' aria-hidden='true'></i></a>";
                ...
                $next_link = "<button name='listViewNextButton' title='{$this->local_app_strings['LNK_LIST_NEXT']}' class='btn pagination-icon-bottom-disabled btn-outline-primary btnbackcolor' disabled style='color:#6d6d6d'><i class='fa fa-caret-right fa-lg' aria-hidden='true'></i></button>";
            } else {
                if($this->multi_select_popup) { // nav links for multiselect popup, submit form to save checks.
					...
					$next_link = "<button name='listViewNextButton' title='{$this->local_app_strings['LNK_LIST_NEXT']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick='javascript:save_checks($next_offset, \"{$moduleString}\");'><i class='fa fa-caret-right fa-lg ' aria-hidden='true'></i></button>";
...
//					$end_link = "<a type='button' name='listViewEndButton' title='{$this->local_app_strings['LNK_LIST_END']}' onClick='location.href=\"$end_URL\"; sListView.save_checks(\"end\", \"{$moduleString}\");'>					<i class='fa fa-angle-double-right fa-lg ' aria-hidden='true'></i></a>";
					...
					$next_link = "<button  name='listViewNextButton' title='{$this->local_app_strings['LNK_LIST_NEXT']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick='location.href=\"$next_URL\"; sListView.save_checks($next_offset, \"{$moduleString}\");'><i class='fa fa-caret-right fa-lg ' aria-hidden='true'></i></button>";
                } else {
                    $onClick = '';
                    ...
                    $next_link = "<button type='button' name='listViewNextButton' title='{$this->local_app_strings['LNK_LIST_NEXT']}' class='btn pagination-icon-bottom btn-outline-primary btnbackcolor' onClick=".$onClick."><i class='fa fa-caret-right fa-lg' aria-hidden='true'></i></button>";
...
$close_inline_img = SugarThemeRegistry::current()->getImage('close_inline', 'border=0', null, null, ".gif", $app_strings['LBL_CLOSEINLINE']);
            ...
            if($this->show_paging == true) {
                ...
                $this->xTemplate->assign("SUBPANEL_TRECID",$html_varName);
            }
