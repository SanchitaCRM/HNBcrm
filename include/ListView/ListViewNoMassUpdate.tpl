...
{include file='include/ListView/ListViewPagination.tpl'}
	...
	<tr height='20'>
		...
		{foreach from=$displayColumns key=colHeader item=params}
            {if $colCounter == '1'}<th scope='col' width='{$params.width}%' style="text-transform:uppercase;font-weight: bold;" data-toggle="true">
            {else}<th scope='col' style="text-transform:uppercase;font-weight: bold;" width='{$params.width}%' data-hide="phone,tablet">{/if}
