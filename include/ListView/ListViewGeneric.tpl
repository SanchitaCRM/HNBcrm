...
{*    <script type="text/javascript" src="modules/Favorites/listview_favourites.js"></script>*}
    ...
    <table cellpadding='0' cellspacing='0' width='100%' border='0' class='list view '>
        <thead>
            ...
            <tr height='20' style="border-bottom: 1px solid #d9dada !important;border-top: 1px solid #d9dada !important;background-color:white !important;">
                {if $prerow}
                    <th width='1%' class="td_alt" style="padding:12px !important;">
                        &nbsp;
                    </th>
                {/if}
{*                <th>&nbsp;</th>*}
                {if !empty($quickViewLinks)}
                    <th class='td_alt' width='1%' style="padding: 0px;">&nbsp;</th>
                {/if}
            ...
            {foreach name=rowIteration from=$data key=id item=rowData}
                ...
                <tr height='20' class='{$_rowColor}S1' style="background-color:white !important">
                   ...
                   {* <td>
                        ...
                        <div class="favorite" id="favorite_icon_outline{$rowData.ID}" record_id="{$rowData.ID}" module="{if $params.dynamic_module}{$rowData[$params.dynamic_module]}{else}{$pageData.bean.moduleDir}{/if}" style="color: #FFD700;margin:2.5px 10px;"><div class="favorite_icon_outline"><i class="fa fa-lg fa-star-o" aria-hidden="true" title="Add to Favorites"></i>
</div>
<div class="favorite_icon_fill" id="favorite_icon_fill{$rowData.ID}" style="display: none;"><i class="fa fa-lg fa-star" aria-hidden="true" title="Add to Favorites"></i>
</div></div>
