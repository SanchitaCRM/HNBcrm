...
$mod_strings['LBL_COLOUR_ADMIN_TABS'] = 'Menu contents config';
    ...
    $mod_strings['LBL_ICON_PICKER_LINK_NAME'] = 'Custom Icons For Modules';
    $mod_strings['LBL_ICON_PICKER_LINK_DESCRIPTION'] = 'Custom Icons For Modules';
    $mod_strings['LBL_ICON_PICKER_SECTION_HEADER'] = 'Custom Icons For Modules';
    $mod_strings['LBL_ICON_PICKER_SECTION_DESCRIPTION'] = 'Custom Icons For Modules';
 ...
 */
    ...
    $mod_strings['LBL_LISTVIEW_FIELD_BACKGROUND_LINK_NAME'] = 'Apply ListView field background color.';
    $mod_strings['LBL_LISTVIEW_FIELD_BACKGROUND_LINK_DESCRIPTION'] = 'Apply background color for field like status.';
    $mod_strings['LBL_LISTVIEW_FIELD_BACKGROUND_SECTION_HEADER'] = 'Field Background for ListView';
    $mod_strings['LBL_LISTVIEW_FIELD_BACKGROUND_SECTION_DESCRIPTION'] = 'Set up different color background for listview and dashlets';
